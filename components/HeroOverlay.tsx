...
export default function HeroOverlay() {
  ...
  return (
    <section className="pointer-events-none absolute inset-0 z-10 flex flex-col items-center justify-center px-5 sm:px-6 text-center text-white pt-16 pb-28 safe-bottom md:pt-20 md:pb-0 overflow-hidden">
      <h1 className="hero-fade-in type-hero text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-5 sm:mb-10 md:mb-14 max-w-4xl">
        {t.hero.slogan}
      </h1>
      <div className="hero-fade-in-delay flex flex-col items-center w-full max-w-2xl overflow-hidden">
