...
export default function CaseCard({
  ...
  return (
    <article className="flex flex-col md:flex-row gap-6 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition-colors">
      ...
      <div className="p-6 flex flex-col justify-center">
        ...
        <h2 className="text-2xl font-light mt-2">{item.title[locale]}</h2>
